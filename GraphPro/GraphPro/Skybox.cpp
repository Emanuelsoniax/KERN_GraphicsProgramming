...
Skybox::Skybox(GLuint& _program) {
    createGeometry(VAO, EBO, boxSize, boxIndexCount);
    program = _program;
}

void Skybox::renderSkyBox(Camera _cam, glm::vec3 _lightDir, glm::mat4 _projection) {
...
void Skybox::createGeometry(GLuint& VAO, GLuint& EBO, int& size, int& numIndices)
{
